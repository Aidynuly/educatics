                                ...
                                <tbody>
                                    @foreach ($cities as $city)
                                        <tr>
                                            <td>{{ $city->id }}</td>
                                            <td></td>
											<td>{{ App\Models\Translate::whereId($city->title)->value('ru') }}</td>
                                            <td>{{ App\Models\Translate::whereId($city->title)->value('en') }}</td>
                                            <td>{{ App\Models\Translate::whereId($city->title)->value('kz') }}</td>
                                            <td>
