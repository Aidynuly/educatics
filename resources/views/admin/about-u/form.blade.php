<div class="box box-info padding-1">
    ...
    <div class="card-body">
        <div class="card-header">
            <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="#russian_description" data-toggle="tab">Russian</a></li>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="kazakh_description">
                    <div class="form-group" id="kz">
                        <label for="ru">KZ</label>
                        <textarea type="text" class="ckeditor form-control" id="ru" name="description_kz" placeholder="Введите название:">
