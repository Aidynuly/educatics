        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('prof-tests.update', $question->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <form action="{{route('answers.destroy', $answer->id)}}" method="post">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <a class="btn btn-sm btn-success" href="{{ route('answers.edit',$answer->id) }}"><i class="fa fa-fw fa-edit"></i></a>
